...
class DebtCollectorService {
	 ...
	 * @return \WhiteLabelMachineName\Sdk\Model\DebtCollector[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WhiteLabelMachineName\Sdk\Model\DebtCollector[]',
				'/debt-collector/all'
			);
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WhiteLabelMachineName\Sdk\Model\DebtCollector[]', $response->getHeaders()));
