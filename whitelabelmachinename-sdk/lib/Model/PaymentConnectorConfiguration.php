...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SalesChannel[] $enabled_sales_channels Defines the sales channels the connector configuration is enabled for. In case the set is empty, the connector configuration is enabled for all sales channels.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PaymentMethodConfiguration $payment_method_configuration 
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PaymentProcessorConfiguration $processor_configuration 
     *
     * @return $this
     */
