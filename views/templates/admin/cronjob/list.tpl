...
<div class="panel col-lg-12">	
	<div class="panel-heading">
		...
		WhiteLabelName {l s='CronJobs' mod='whitelabelmachinename'}
	</div>
				...
				<thead>
					<tr class="nodrag nodrop">
						<th class="fixed-width-xs text-center">
							<span class="title_box">{l s='ID' mod='whitelabelmachinename'}</span>
						</th>
						<th class="fixed-width-s text-center">
							<span class="title_box">{l s='State' mod='whitelabelmachinename'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Scheduled' mod='whitelabelmachinename'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Started' mod='whitelabelmachinename'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Finished' mod='whitelabelmachinename'}</span>
						</th>
						<th class="fixed-width-l center">
							<span class="title_box">{l s='Message' mod='whitelabelmachinename'}</span>
						</th>
					</tr>
				...
				{else}
					<tr>
						<td class="text-center" colspan="6">
							{l s='No cron available yet.' mod='whitelabelmachinename'}
						</td>
					</tr>
				{/if}
				</tbody>
