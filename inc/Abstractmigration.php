...
abstract class WhiteLabelMachineNameAbstractmigration
{
    ...
    protected static function installTableBase()
    {
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "wlm_refund_job(
    ...
    {
        $authorizedStatus = WhiteLabelMachineNameOrderstatus::getAuthorizedOrderStatus();
        $waitingStatus = WhiteLabelMachineNameOrderstatus::getWaitingOrderStatus();
        $manualStatus = WhiteLabelMachineNameOrderstatus::getManualOrderStatus();

        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_FAILED, Configuration::get('PS_OS_ERROR'));
        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_AUTHORIZED, $authorizedStatus->id);
        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_VOIDED, Configuration::get(
            'PS_OS_CANCELED'
        ));
        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_COMPLETED, $waitingStatus->id);
        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_MANUAL, $manualStatus->id);
        Configuration::updateGlobalValue(
            WhiteLabelMachineNameBasemodule::CK_STATUS_DECLINED,
            Configuration::get('PS_OS_CANCELED')
        );
        Configuration::updateGlobalValue(WhiteLabelMachineNameBasemodule::CK_STATUS_FULFILL, Configuration::get(
            'PS_OS_PAYMENT'
        ));
    }
