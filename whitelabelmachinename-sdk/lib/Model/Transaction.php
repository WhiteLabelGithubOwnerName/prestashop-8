...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'allowed_payment_method_brands' => '\WhiteLabelMachineName\Sdk\Model\PaymentMethodBrand[]',
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PaymentMethodBrand[] $allowed_payment_method_brands 
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which this transaction was successfully authorized.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionCompletionBehavior $completion_behavior The completion behavior controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates what kind of authentication methods can be used during the authorization of the transaction. If no value is provided, 'Virtually Present' is used by default.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The environment selection strategy determines how the environment (test or production) for processing the transaction is selected.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WhiteLabelMachineName\Sdk\Model\FailureReason $failure_reason The failure reason describes why the transaction failed. This is only provided when the transaction is marked as failed.
     *
     * @return $this
     */
     ...
     * Sets group
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionGroup $group 
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionState $state 
     *
     * @return $this
     */
     ...
     * Sets terminal
     *
     * @param \WhiteLabelMachineName\Sdk\Model\PaymentTerminal $terminal The terminal on which the payment was processed.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode controls if and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionUserInterfaceType $user_interface_type The user interface type defines through which user interface the transaction has been processed resp. created.
     *
     * @return $this
     */
