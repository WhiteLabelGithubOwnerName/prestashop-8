...
{if (isset($showAuthorizedActions) && $showAuthorizedActions)}
	<div style="display:none;" class="hidden-print">
		<a class="btn btn-default whitelabelmachinename-management-btn"  id="whitelabelmachinename_void">
			<i class="icon-remove"></i>
			{l s='Void' mod='whitelabelmachinename'}
		</a>
		<a class="btn btn-default whitelabelmachinename-management-btn"  id="whitelabelmachinename_completion">
			<i class="icon-check"></i>
			{l s='Completion' mod='whitelabelmachinename'}
		</a>	
	</div>
	
	{addJsDefL name=whitelabelmachinename_void_title}{l s='Are you sure?' mod='whitelabelmachinename' js=1}{/addJsDefL}
	{addJsDefL name=whitelabelmachinename_void_btn_confirm_txt}{l s='Void Order'  mod='whitelabelmachinename' js=1}{/addJsDefL}
	{addJsDefL name=whitelabelmachinename_void_btn_deny_txt}{l s='No' mod='whitelabelmachinename' js=1}{/addJsDefL}
	...
	{addJsDefL name=whitelabelmachinename_completion_title}{l s='Are you sure?' mod='whitelabelmachinename' js=1}{/addJsDefL}
	{addJsDefL name=whitelabelmachinename_completion_btn_confirm_txt}{l s='Complete Order'  mod='whitelabelmachinename' js=1}{/addJsDefL}
	{addJsDefL name=whitelabelmachinename_completion_btn_deny_txt}{l s='No' mod='whitelabelmachinename' js=1}{/addJsDefL}
...
{addJsDefL name=whitelabelmachinename_msg_general_error}{l s='The server experienced an unexpected error, please try again.'  mod='whitelabelmachinename' js=1}{/addJsDefL}
{addJsDefL name=whitelabelmachinename_msg_general_title_succes}{l s='Success'  mod='whitelabelmachinename' js=1}{/addJsDefL}
{addJsDefL name=whitelabelmachinename_msg_general_title_error}{l s='Error'  mod='whitelabelmachinename' js=1}{/addJsDefL}
{addJsDefL name=whitelabelmachinename_btn_info_confirm_txt}{l s='OK'  mod='whitelabelmachinename' js=1}{/addJsDefL}
