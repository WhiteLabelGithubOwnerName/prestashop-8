...
class PaymentMethodConfiguration implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DataCollectionType $data_collection_type The data collection type determines who is collecting the payment information. This can be done either by the processor (offsite) or by our application (onsite).
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString $description The payment method configuration description can be used to show a text during the payment process. Choose an appropriate description as it will be displayed to your customer.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\ModelResourcePath $image_resource_path The image of the payment method configuration overrides the default image of the payment method.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param \WhiteLabelMachineName\Sdk\Model\CreationEntityState $state 
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString $title The title of the payment method configuration is used within the payment process. The title is visible to the customer.
     *
     * @return $this
     */
