...
class ConditionTypeService {
	 ...
	 * @return \WhiteLabelMachineName\Sdk\Model\ConditionType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WhiteLabelMachineName\Sdk\Model\ConditionType[]',
				'/condition-type/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WhiteLabelMachineName\Sdk\Model\ConditionType[]', $response->getHeaders()));
