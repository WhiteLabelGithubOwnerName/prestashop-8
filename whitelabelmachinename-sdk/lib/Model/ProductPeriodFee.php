...
class ProductPeriodFee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'ledger_entry_title' => '\WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString',
        'linked_space_id' => 'int',
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString $ledger_entry_title The ledger entry title will be used for the title in the ledger entry and in the invoice.
     *
     * @return $this
     */
