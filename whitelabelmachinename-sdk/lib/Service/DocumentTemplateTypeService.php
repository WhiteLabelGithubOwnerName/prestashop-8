...
class DocumentTemplateTypeService {
	 ...
	 * @return \WhiteLabelMachineName\Sdk\Model\DocumentTemplateType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WhiteLabelMachineName\Sdk\Model\DocumentTemplateType[]',
				'/document-template-type/all'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WhiteLabelMachineName\Sdk\Model\DocumentTemplateType[]', $response->getHeaders()));
