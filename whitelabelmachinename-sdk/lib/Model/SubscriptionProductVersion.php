...
class SubscriptionProductVersion implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'tax_calculation' => '\WhiteLabelMachineName\Sdk\Model\TaxCalculation',
        'version' => 'int'
    ];
     ...
     * Sets name
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString $name The product version name is the name of the product which is shown to the user for the version. When the visible product name should be changed for a particular product a new version has to be created which contains the new name of the product.
     *
     * @return $this
     */
     ...
     * Sets product
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionProduct $product Each product version is linked to a product.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \WhiteLabelMachineName\Sdk\Model\SubscriptionProductVersionState
     */
     ...
     * Sets state
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SubscriptionProductVersionState $state The object's current state.
     *
     * @return $this
     */
     ...
     *
     * @return \WhiteLabelMachineName\Sdk\Model\TaxCalculation
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TaxCalculation $tax_calculation Strategy that is used for tax calculation in fees.
     *
     * @return $this
     */
