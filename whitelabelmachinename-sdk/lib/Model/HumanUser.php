...
class HumanUser implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'primary_account' => '\WhiteLabelMachineName\Sdk\Model\Account',
        'scope' => '\WhiteLabelMachineName\Sdk\Model\Scope',
        'time_zone' => 'string',
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Account $primary_account The primary account links the user to a specific account.
     *
     * @return $this
     */
     ...
     * Gets scope
     *
     * @return \WhiteLabelMachineName\Sdk\Model\Scope
     */
     ...
     * Sets scope
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Scope $scope The scope to which the user belongs to.
     *
     * @return $this
     */
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TwoFactorAuthenticationType $two_factor_type 
     *
     * @return $this
     */
