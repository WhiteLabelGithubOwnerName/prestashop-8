...
class Role implements ModelInterface, ArrayAccess
{
     ...
     * Sets account
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Account $account The account to which this role belongs to. This role can only be assigned within the assigned account and the sub accounts of the assigned account.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param \WhiteLabelMachineName\Sdk\Model\DatabaseTranslatedString $name The name of this role is used to identify the role within administrative interfaces.
     *
     * @return $this
     */
     ...
     * Sets permissions
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Permission[] $permissions Set of permissions that are granted to this role.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param \WhiteLabelMachineName\Sdk\Model\RoleState $state 
     *
     * @return $this
     */
