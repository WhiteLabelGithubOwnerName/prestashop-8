...
class MerticUsageService {
	 ...
	 * @return \WhiteLabelMachineName\Sdk\Model\MetricUsage[]
	 */
	...
	public function calculateWithHttpInfo($space_id, $start, $end) {
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\WhiteLabelMachineName\Sdk\Model\MetricUsage[]',
				'/mertic-usage/calculate'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\WhiteLabelMachineName\Sdk\Model\MetricUsage[]', $response->getHeaders()));
