...
class WhiteLabelMachineNameCheckoutModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            if ($methodId !== null) {
                ...
                WhiteLabelMachineNameServiceTransaction::instance()->getTransactionFromCart($cart);
            }
            $cartHash = WhiteLabelMachineNameHelper::calculateCartHash($cart);
