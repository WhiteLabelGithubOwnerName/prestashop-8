...
class WebhookListener implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'int',
        'identity' => '\WhiteLabelMachineName\Sdk\Model\WebhookIdentity',
        'linked_space_id' => 'int',
        'name' => 'string',
        'notify_every_change' => 'bool',
        'planned_purge_date' => '\DateTime',
        'state' => '\WhiteLabelMachineName\Sdk\Model\CreationEntityState',
        'url' => '\WhiteLabelMachineName\Sdk\Model\WebhookUrl',
        'version' => 'int'
    ];
     ...
     * Gets identity
     *
     * @return \WhiteLabelMachineName\Sdk\Model\WebhookIdentity
     */
     ...
     * Sets identity
     *
     * @param \WhiteLabelMachineName\Sdk\Model\WebhookIdentity $identity The identity which will be used to sign messages sent by this listener.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param \WhiteLabelMachineName\Sdk\Model\WebhookUrl $url The URL which is invoked by the listener to notify the application about the event.
     *
     * @return $this
     */
