...
class WhiteLabelMachineNameWebhookModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $webhookService = WhiteLabelMachineNameServiceWebhook::instance();
        ...
        try {
            ...
            $request = new WhiteLabelMachineNameWebhookRequest($parsed);
            ...
            PrestaShopLogger::addLog($e->getMessage(), 3, null, 'WhiteLabelMachineNameWebhookEntity');
            echo $e->getMessage();
            die();
        }
    }
