...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'name' => 'string',
        'postal_address' => '\WhiteLabelMachineName\Sdk\Model\SpaceAddressCreate',
     ...
     * Gets postal_address
     *
     * @return \WhiteLabelMachineName\Sdk\Model\SpaceAddressCreate
     */
     ...
     * Sets postal_address
     *
     * @param \WhiteLabelMachineName\Sdk\Model\SpaceAddressCreate $postal_address The address to use in communication with clients for example in email, documents etc.
     *
     * @return $this
     */
