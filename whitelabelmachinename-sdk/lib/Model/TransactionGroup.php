...
class TransactionGroup implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'state' => '\WhiteLabelMachineName\Sdk\Model\TransactionGroupState',
        'version' => 'int'
    ];
     ...
     * Gets state
     *
     * @return \WhiteLabelMachineName\Sdk\Model\TransactionGroupState
     */
     ...
     * Sets state
     *
     * @param \WhiteLabelMachineName\Sdk\Model\TransactionGroupState $state The object's current state.
     *
     * @return $this
     */
