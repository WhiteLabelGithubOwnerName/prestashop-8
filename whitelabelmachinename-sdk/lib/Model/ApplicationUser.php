...
class ApplicationUser extends User 
{
     ...
     *
     * @param \WhiteLabelMachineName\Sdk\Model\Account $primary_account The account that this user is associated with. The account owner will be able to manage this user.
     *
     * @return $this
     */
